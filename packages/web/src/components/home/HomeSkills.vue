...
const skills: Skill[] = [
  ...
  { id: 'shot',       name: '镜头设计', desc: '生成专业镜头语言',     icon: 'image-placeholder', hue: '59 130 246' },
  { id: 'storyboard', name: '分镜生成', desc: '生成分镜脚本与画面',   icon: 'template-grid', hue: '168 85 247' },
  { id: 'video',      name: '视频生成', desc: '一键生成高质量视频',   icon: 'grid',          hue: '20 184 166' },
