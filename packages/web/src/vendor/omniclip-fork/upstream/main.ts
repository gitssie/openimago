...
// Moved to ./tools/remove-loading-page-indicator.js so the context can import it
// without dragging main.ts's side effects; re-exported here for back-compat.
export {removeLoadingPageIndicator} from "./tools/remove-loading-page-indicator.js"
